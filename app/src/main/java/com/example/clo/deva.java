...
public class deva extends AppCompatActivity {
    Button submit;
    EditText add;
    ImageView imageView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            private void validateData() {
                ...
                if (data.isEmpty()) {
                    Toast.makeText(deva.this, "Please enter data", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void getpdfurl() {
        ...
        df.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(deva.this ,"NO URL PRESENT",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void pdfdownload(String url) {
        if (url != null && !url.isEmpty()) {
            ...
            Toast.makeText(deva.this, "No valid URL", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void upPDF() {
        if (pdfuri != null) {
            ...
            ref.putFile(pdfuri).addOnSuccessListener(taskSnapshot -> {
                ...
                Toast.makeText(deva.this, "PDF upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            });
        }
        else{
            Toast.makeText(deva.this,"PDf failed" , Toast.LENGTH_SHORT).show();
        }}
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ref.child(pdfnum).setValue(downloadUrl).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(deva.this, "PDF URL saved successfully", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(deva.this, "Failed to save PDF URL", Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    private void upImage() {
        if (imageUri != null) {
            ...
            fileReference.putFile(imageUri).addOnSuccessListener(taskSnapshot -> {
                ...
                Toast.makeText(deva.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            });
        } else {
    ...
    private void saveImageUrlToDatabase(String downloadUrl) {
        ...
        qpReference.child("imageUrl").setValue(downloadUrl).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                Toast.makeText(deva.this, "Image URL saved successfully", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(deva.this, "Failed to save URL", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addCategory(String categoryName) {
        ...
        for (String s : insideCategory) {
            subjectRef.child(s).setValue("pending").addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    Toast.makeText(deva.this, "Submitted", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(deva.this, "Submission failed", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
